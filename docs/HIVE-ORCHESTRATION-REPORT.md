...
orchestrated through AIMS and RAMS. MAST now sends one monthly website-audit trigger to AIMS, which owns Digital Growth, SEO/AEO/GEO, Mobile UX, council synthesis, final PDF/HTML/JSON publication, temporary cleanup, and the exact-key RAMS website handoff. The old fixed-time SEO/AEO/GEO and Mobile UX RAMS schedules are retired; on-brand and other brand/social work remains separate. Re-adding website remediation schedules against HIVE
would create duplicate, conflicting ownership for work already owned by AIMS.
...
existing 07:30 AIMS resume and ahead of the single 08:15 website-audit trigger and later brand/social jobs, so they
