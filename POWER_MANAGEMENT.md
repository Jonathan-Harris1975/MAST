...
job including the monthly audit sequence (15:00-18:20 on the 1st):
...
**RAMS** - running window ~08:00-20:00 Europe/London, 1st of the month only (RAMS's
tasks now run inside the same daily boundary as AIMS instead of overnight):

| Job | Schedule | Action |
| --- | --- | --- |
| `rams-power-resume-monthly` | 1st of month, 08:00 | resume (30 min before the 08:30 rebuild sequence starts) |
| `rams-power-pause-monthly` | 1st of month, 20:00 | pause (RAMS's last scheduled job finishes by 12:10; this leaves a wide margin for manual reruns before pausing at the same 20:00 boundary as AIMS) |
