...
const operationWindowJobs = [
  ...["monday", "tuesday", "wednesday", "thursday", "friday"].map((day) => postJob({
    ...
    schedule: { type: "weekly", days: [day], time: String(process.env.MAST_AM_OPERATION_TIME || "08:30"), timezone: LOCAL_TIME_ZONE },
    hookEnv: null,
  ...
  ...["monday", "tuesday", "wednesday","thursday"].map((day) => postJob({
    ...
    schedule: { type: "weekly", days: [day], time: String(process.env.MAST_PM_OPERATION_TIME || "21:33"), timezone: LOCAL_TIME_ZONE },
    hookEnv: null,
