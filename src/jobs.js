...
const monthlyAuditJobs = [
  postJob({
    ...
    schedule: { type: "monthly", dayOfMonth: 7, time: "08:30", timezone: "UTC" },
  ...
  postJob({
    ...
    schedule: { type: "monthly", dayOfMonth: 17, time: "11:20", timezone: "UTC" },
  ...
  postJob({
    ...
    schedule: { type: "monthly", dayOfMonth: 7, time: "09:00", timezone: "UTC" },
  ...
  postJob({
    ...
    schedule: { type: "monthly", dayOfMonth: 1, time: "17:40", timezone: "UTC" },
