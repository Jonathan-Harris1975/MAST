...
const operationWindowJobs = [
  ...["monday", "tuesday", "wednesday", "thursday", "friday"].map((day) => postJob({
    ...
    schedule: { type: "weekly", days: [day], time: String(process.env.MAST_AM_OPERATION_TIME || "04:20"), timezone: LOCAL_TIME_ZONE },
    hookEnv: null,
  ...
  ...["monday", "tuesday", "wednesday","thursday"].map((day) => postJob({
    ...
    schedule: { type: "weekly", days: [day], time: String(process.env.MAST_PM_OPERATION_TIME || "16:20"), timezone: LOCAL_TIME_ZONE },
    hookEnv: null,
