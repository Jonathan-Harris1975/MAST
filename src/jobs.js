...
const hiveGovernanceWeeklyJobs = [
  ...
  hiveJob({
    ...
    group: "hive-governance-weekly",
    description: "Check HIVE's bounded repository-local capability catalogue for integrity issues (Knowledge Base Review).",
    ...
    responsePolicy: { checks: [{ type: "equals", path: "ok", value: true, message: "HIVE local catalogue integrity query did not complete successfully." }] },
  }),
  hiveJob({
...
const hiveGovernanceMonthlyJobs = [
  ...
  hiveJob({
    ...
    description: "Deep monthly check for duplicate entries in HIVE's repository-local capability catalogue.",
    ...
    consumeFailureWindow: true,
    responsePolicy: { checks: [{ type: "equals", path: "ok", value: true, message: "HIVE duplicate check could not read the local catalogue." }] },
  }),
  hiveJob({
    id: "hive-skills-orphans-check",
    group: "hive-skills-catalogue",
    description: "Deep monthly check for local capability records no longer referenced by a HIVE workflow.",
    ...
    consumeFailureWindow: true,
    responsePolicy: { checks: [{ type: "equals", path: "ok", value: true, message: "HIVE orphan check could not read the local catalogue." }] },
  }),
  hiveJob({
    id: "hive-skills-missing-check",
    group: "hive-skills-catalogue",
    description: "Deep monthly check for HIVE workflows that reference missing local capability records.",
    ...
    consumeFailureWindow: true,
    responsePolicy: { checks: [{ type: "equals", path: "ok", value: true, message: "HIVE missing-record check could not read the local catalogue." }] },
  }),
  hiveJob({
  ...
  hiveJob({
    ...
    description: [
      ...
      "repository-local capability catalogue health, optimisation stats, execution review posture, token usage and cost) for the month",
