...
const monthlyAuditJobs = [
  postJob({
    ...
    schedule: { type: "monthly", dayOfMonth: 7, time: "02:00", timezone: "UTC" },
  ...
  postJob({
    ...
    schedule: { type: "monthly", dayOfMonth: 1, time: "07:20", timezone: "UTC" },
  ...
  postJob({
    ...
    schedule: { type: "monthly", dayOfMonth: 7, time: "03:00", timezone: "UTC" },
